...
const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="relative pt-24 pb-12 md:pt-32 md:pb-20 overflow-hidden bg-gradient-to-b from-indigo-50 to-white" aria-labelledby="hero-heading">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <h1 id="hero-heading" className="text-4xl md:text-7xl font-extrabold tracking-tight text-gray-900 mb-6">
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
          <a
            ...
            className="px-8 py-4 bg-green-500 text-white rounded-full font-bold text-lg shadow-xl hover:bg-green-600 hover:scale-105 transition-all text-center flex items-center justify-center gap-2"
            aria-label="צרו קשר עם אסתר צימרמן בוואטסאפ"
